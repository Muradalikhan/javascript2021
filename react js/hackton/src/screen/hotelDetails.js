                ...
                <div className="card mb-5 p-2" style={{ maxWidth: '80%',margin:'0 auto' }}>
                    <div className="row g-0">
                        <div className="col-md-4">
                            <img src={location.hotelImgUrl} className="img-fluid rounded-start" style={{height:'500px',width:'350px'}} alt="cardimage" />
                        </div>
                        <div className="col-md-8">
                            <div className="card-body">
                                <h5 className="card-title btnColor">{location.name}</h5>
                                <p className="card-text"> {location.services}</p>
                                <span className="">Offering an outdoor pool and a spa and wellness centre, Ramada Plaza by Wyndham Karachi Airport Hotel is located in Karachi. Free WiFi access is available.</span>
                                <p className="card-text">Price per day: ${location.price}   <span className=" text-info p-2 mx-3 rounded">Availible Room: {location.room}</span></p>
