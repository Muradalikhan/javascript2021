    ...
    return (
        ...
        <div className='text-center mx-auto w-75' >
            ...
            <Paper elevation={12} className='p-2 my-2 '>
                <Grid container>
                    <Grid md={8}>
                        <InfoBoard color='green' title='Confirmed Cases'/>
                        <InfoBoard color='red' title='Death'/>
                        <InfoBoard color='yellow' title='Recovered Cases'/>
                        <InfoBoard color='lightgrey' title='Active Cases'/>
